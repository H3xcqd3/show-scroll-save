        ...
        <Collapsible defaultOpen>
          <CollapsibleTrigger className="flex w-full items-center justify-between rounded-xl bg-card p-4 shadow-card hover:bg-card/80 transition-colors">
            <div className="flex items-center gap-3">
              ...
              <span className="font-display text-lg font-semibold text-foreground">Profile Info</span>
            </div>
            <ChevronDown className="h-5 w-5 text-muted-foreground transition-transform duration-200 [[data-state=open]>&]:rotate-180" />
          </CollapsibleTrigger>
          <CollapsibleContent className="overflow-hidden data-[state=open]:animate-accordion-down data-[state=closed]:animate-accordion-up">
            <div className="rounded-b-xl border border-t-0 border-border bg-card px-6 py-5 shadow-card space-y-6">
        ...
        <Collapsible>
          <CollapsibleTrigger className="flex w-full items-center justify-between rounded-xl bg-card p-4 shadow-card hover:bg-card/80 transition-colors">
            <div className="flex items-center gap-3">
              ...
              <span className="font-display text-lg font-semibold text-foreground">Account</span>
            </div>
            <ChevronDown className="h-5 w-5 text-muted-foreground transition-transform duration-200 [[data-state=open]>&]:rotate-180" />
          </CollapsibleTrigger>
          <CollapsibleContent className="overflow-hidden data-[state=open]:animate-accordion-down data-[state=closed]:animate-accordion-up">
            <div className="rounded-b-xl border border-t-0 border-border bg-card px-6 py-5 shadow-card space-y-1 text-sm text-muted-foreground">
